    ...
    return _regeneratorRuntime.async(function getRuleList$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            ...
            case 2:
                ...
                context$1$0.next = 6;
                return _regeneratorRuntime.awrap(Q.nfcall(fs.readFile, path.join(__dirname, '../resources/builtin.txt'), 'utf-8'));

            case 6:
                builtIn = context$1$0.sent;
    ...
    return _regeneratorRuntime.async(function reduceDomains$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            ...
            case 2:
                ...
                tlds = new _Set(tldContent.split(/\r?\n/g));
                newDomains = new _Set();
